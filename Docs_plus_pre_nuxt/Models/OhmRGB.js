...
class OhmRGB extends HardwareInterface {
    ...
    generateButtonsInputTable(){
        ...
        //faders
        for(let i = 0; i <= 7; i++) {
            buttons.push( new DigitalInput( count, '', false, 'fader',  0, 0) );
            count++;
        }
    ...
    buildAnalogInputsTable(){
        ...
        //faders
        for(let i = 0; i <= 7; i++){
            inputs.push(new AnalogInput(count, undefined, 'fader'));
            count++;
        }
    ...
    */
    assignSysExBytePosToDigitalInputsTable(){
        ...
        //function
        let functonStartPos = 77
        for(let i = 74; i<=79; i++){
            this.digital_inputs_table[i].sysex_byte_position = i <= 76  ? functonStartPos++ : functonStartPos++ - 11;
        }
    ...
    getInputGroupMidiValues(groupName){
        ...
        console.log({
            name: 'input group midi vals',
            group: groupName,
            inputs: this.digital_inputs_table,
            values: midiValues
        });
